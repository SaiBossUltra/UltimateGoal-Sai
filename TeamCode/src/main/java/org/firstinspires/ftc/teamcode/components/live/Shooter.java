...
public class Shooter extends Component {
    ...
    public void spin(boolean wait, double speed) {
        flywheel.setVelocity(speed);
        while(wait && isOpmodeActive() && Math.abs(flywheel.getVelocity() - speed) > ShooterConfig.VELOCITY_ERROR) {
            flywheel.setVelocity(speed);
        }
    }
    ...
    public double getShooterSpped() {
        return ShooterConfig.target_speed;
    }
}
